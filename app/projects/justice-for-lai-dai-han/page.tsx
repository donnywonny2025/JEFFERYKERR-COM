...
export default function JusticeForLaiDaiHanPage() {
  const [menuOpen, setMenuOpen] = useState(false);
  const router = useRouter();

  const vimeoId = '641889858';
        ...
        >
          ...
          >
            ...
            <section style={{ ...columnStyle, marginBottom: '60px' }}>
              ...
              >
                Documentary work highlighting the stories of Lai Dai Han - tens of thousands of children born to Vietnamese women raped by South Korean soldiers during the Vietnam War. Justice for Lai Dai Han campaigns for South Korea to recognize and apologize for widespread sexual violence committed by its troops between 1964-1973. More than 800 victims are still alive, and their children face social exclusion and stigma in Vietnamese society. This piece gives voice to survivors of conflict-related sexual violence and advocates for acknowledgment, justice, and reconciliation.
              </p>
            </section>
