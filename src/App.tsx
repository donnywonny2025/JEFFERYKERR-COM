...
export default function HomePage() {
  ...
  return (
    <div className="site" style={{ backgroundColor: '#000', color: '#fff', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      {/* Loading message for immediate feedback */}
      <div style={{color: 'white', textAlign: 'center', padding: '50px', background: '#000', flex: 1}}>
        <h1>Jeffrey Kerr Portfolio Loading...</h1>
        <p>Site is initializing. If you see this, the app is working.</p>
      </div>
        ...
        <section className="hero">
          ...
          <div className="hero-content">
            <div className="text-block">
              <h1>Jeffrey Kerr pushes the boundaries of visual storytelling through AI-enhanced creative direction and 15+ years of proven expertise</h1>
